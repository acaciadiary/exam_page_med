...
export function QuestionCard({
  ...
  return (
    <motion.article
      id={question.id}
      layout
      className="relative min-w-0 overflow-hidden scroll-mt-32 rounded-[1.45rem] border border-white/90 bg-white/82 p-5 shadow-[0_18px_60px_rgba(181,133,117,0.16)] backdrop-blur-2xl sm:p-7"
    >
